...
class SafeUrlValidatorTest < ActiveSupport::TestCase
  ...
  setup do
    @model_class = Class.new do
      ...
      validates :website, safe_url: { no_local: true }, allow_blank: true
    ...
    @email_model_class = Class.new do
      ...
      validates :lien_dpo, safe_url: { no_local: true, accept_email: true }, allow_blank: true
  ...
  test "invalid with localhost" do
    ...
    assert_not record.valid?
    assert record.errors[:website].any? { |e| e.include?("private") }
  end
